...
if (!current_user_can("manage_options")) {
   ...
   if (is_multisite()) {
     ...
     foreach ($blog_ids as $blog_id) {
         ...
         if ($gallery_master_version_number != "") {
         ...
         if ($get_other_settings_data["remove_table_at_uninstall"] == "enable") {
            $wpdb->query("DROP TABLE IF EXISTS " . $wpdb->prefix . "gallery_master");
            $wpdb->query("DROP TABLE IF EXISTS " . $wpdb->prefix . "gallery_master_meta");
