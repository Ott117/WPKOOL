               ...
               <ul class="page-sidebar-menu-tech-banker" data-slide-speed="200">
                  <div class="sidebar-search-wrapper" style="padding:20px;text-align:center">
                     <a class="plugin-logo" href="<?php echo tech_banker_gallery_url; ?>" target="_blank">
                        <img src="<?php echo GALLERY_MASTER_PLUGIN_DIR_URL . "assets/global/img/logo.png"; ?>"/>
                     </a>
                  </div>
                  ...
                  <li id="ux_li_shortcode_generator">
                     ...
                     <ul class="sub-menu">
                        ...
                        <li id="ux_li_masonry_layout_shortcode">
                           <a href="admin.php?page=gm_masonry_layout_shortcode">
                              <i class="icon-custom-energy"></i>
                              <?php echo $gm_masonry_layout; ?>
                           </a>
                        </li>
                        <li id="ux_li_slideshow_layout_shortcode">
                           <a href="admin.php?page=gm_slideshow_layout_shortcode">
                              <i class="icon-custom-control-play"></i>
                              <?php echo $gm_slideshow_layout; ?>
                              <span class="badge">Pro</span>
                           </a>
                        ...
                        <li id="ux_li_image_browser_layout_shortcode">
                           <a href="admin.php?page=gm_image_browser_layout_shortcode">
                              <i class="icon-custom-feed"></i>
                              <?php echo $gm_image_browser_layout; ?>
                              <span class="badge">Pro</span>
                           </a>
                        ...
                        <li id="ux_li_justified_grid_layout_shortcode">
                           <a href="admin.php?page=gm_justified_grid_layout_shortcode">
                              <i class="icon-custom-grid"></i>
                              <?php echo $gm_justified_grid_layout; ?>
                              <span class="badge">Pro</span>
                           </a>
                        ...
                        <li id="ux_li_blog_style_layout_shortcode">
                           <a href="admin.php?page=gm_blog_style_layout_shortcode">
                              <i class="icon-custom-bubble"></i>
                              <?php echo $gm_blog_style_layout; ?>
                              <span class="badge">Pro</span>
                           </a>
                  ...
                  <li id="ux_li_pricing_plans">
                     <a href="https://gallery-master.tech-banker.com/pricing/" target="_blank">
                        <i class="icon-custom-key"></i>
                        <span class="title">
                           <strong style="color:yellow;">
                              <?php echo $gm_pricing_plans; ?>
                           </strong>
                        </span>
                     </a>
                  </li>
