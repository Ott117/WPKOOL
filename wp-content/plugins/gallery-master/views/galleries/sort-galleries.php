                     ...
                     <div class="form-body">
                        <div class="form-actions">
                           <div class="pull-right">
                              <input type="submit" class="btn vivid-green" id="ux_ddl_submit" name="ux_ddl_submit" value="<?php echo $gm_save_changes; ?>">
                           </div>
                        </div>
                        ...
                        <div class="form-group">
                           <label class="control-label">
                              ...
                              <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_sort_galleries_choose_gallery_tooltip; ?>" data-placement="right"></i>
                           ...
                           <select name="ux_ddl_sort_galleries" id="ux_ddl_sort_galleries" class="form-control" onchange="choose_gallery_gallery_master(this.value);">
                              <option value=""><?php echo $gm_sort_galleries_choose_gallery_title; ?></option>
                              <?php
                                          ...
                                          <div class="thumbnail-csb">
                                             <div class="centered-csb">
                                                ...
                                                if ($image["file_type"] == "image") {
                                                   ...
                                                   ?>
                                                   <img src="<?php echo $gm_gallery_image; ?>" id="ux_txt_img_<?php echo intval($image["id"]); ?>" name="ux_txt_img_<?php echo intval($image["id"]); ?>" img_name="<?php echo esc_attr($image["image_name"]); ?>">
                                                   <?php
                                                } else {
                                                   ?>
