                     ...
                     <div class="form-body">
                        <div class="form-group">
                           <label class="control-label">
                              <?php echo $gm_custom_css; ?> :
                              <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_custom_css_tooltip; ?>" data-placement="right"></i>
                           </label>
                           <textarea rows="20" class="form-control" name="ux_txt_custom_css" placeholder="<?php echo $gm_custom_css_placeholder; ?>" id="ux_txt_custom_css"><?php echo isset($details_custom_css["custom_css"]) ? esc_attr($details_custom_css["custom_css"]) : ""; ?></textarea>
                        </div>
                        <div class="line-separator"></div>
                        <div class="form-actions">
                           <div class="pull-right">
                              <input type="submit" value="<?php echo $gm_save_changes; ?>" class="btn vivid-green" name="ux_btn_custom_css" id="ux_btn_custom_css">
                           </div>
                        </div>
                     </div>
                  </form>
