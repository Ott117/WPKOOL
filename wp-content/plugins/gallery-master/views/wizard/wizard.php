...
if (!is_user_logged_in()) {
   ...
   <script type="text/javascript">
      if (typeof overlay_loading_gallery_master !== "function") {
      ...
      if (typeof remove_overlay_gallery_master !== "function") {
         function remove_overlay_gallery_master() {
            jQuery(".loader_opacity").remove();
            jQuery(".opacity_overlay").remove();
         }
      }
      if (typeof show_hide_details_gallery_master !== "function") {
      ...
      if (typeof plugin_stats_gallery_master !== "function") {
                  ...
                  <div class="row row-custom">
                      <div class="col-md-12">
                        ...
                        <div class="textalign">
                            ...
                            <p><strong>Gallery Master will still work fine.</strong></p>
                        </div>
                    </div>
                     <div class="col-md-12">
                        <a class="permissions" onclick="show_hide_details_gallery_master();">What permissions are being granted?</a>
                     </div>
