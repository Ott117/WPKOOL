                     ...
                     <div class="form-body">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo$gm_global_option_filter_font_style_tooltips; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon-right">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_filters_font_style[]" id="ux_txt_filters_font_style" onblur="default_value_gallery_master('#ux_txt_filters_font_style', 14);" placeholder="<?php echo$gm_font_size_placeholder; ?>" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($filters_font_style[0]); ?>">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_filters_font_style[]" id="ux_txt_style_color"  onblur="default_value_gallery_master('#ux_txt_style_color', '#000000');" onfocus="color_picker_gallery_master(this, this.value)" placeholder="<?php echo$gm_color_placeholder; ?>" value="<?php echo esc_attr($filters_font_style[1]); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo$gm_global_option_filter_font_family_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="ux_txt_global_filters_active_font_hover_color" id="ux_txt_global_filters_active_font_hover_color" onblur="default_value_gallery_master('#ux_txt_global_filters_active_font_hover_color', '#2fbfc1');" placeholder="<?php echo $gm_global_option_active_font_hover_color_placeholder; ?>"  onfocus="color_picker_gallery_master(this, this.value)" value="<?php echo isset($filter_settings_get_data["filters_active_font_hover_color"]) ? esc_attr($filter_settings_get_data["filters_active_font_hover_color"]) : "#000000"; ?>">
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_filter_background_color_tooltips; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_controls[]" id="ux_txt_global_option_filters_background_colory" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo $gm_background_transparency_placeholder; ?>" value="<?php echo esc_attr($filter_background_color_controls[0]); ?>">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_controls[]" id="ux_txt_global_option_filters_background_color_transparenc" placeholder="<?php echo $gm_lightbox_colorbox_background_color_placeholder; ?>" onblur="default_value_gallery_master('#ux_txt_global_option_filters_background_color_transparenc', 100)" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onchange="check_opacity_gallery_master(this);" value="<?php echo intval($filter_background_color_controls[1]); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="ux_txt_filters_background_hover_color" id="ux_txt_filters_background_hover_color" placeholder="<?php echo $gm_global_option_filter_background_hover_color_placeholder; ?>"  onfocus="color_picker_gallery_master(this, this.value)" value="<?php echo isset($filter_settings_get_data["filters_background_hover_color"]) ? esc_attr($filter_settings_get_data["filters_background_hover_color"]) : "#000000"; ?>">
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_filter_border_style_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control input-width-25 input-inline" name="ux_txt_filters_border_style[]" id="ux_txt_filter_border_style_width" placeholder="<?php echo $gm_width_placeholder; ?>" onblur="default_value_gallery_master('#ux_txt_filter_border_style_width', 2)" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($filter_border_color[0]); ?>">
                                    ...
                                    <input type="text" class="form-control input-normal input-inline" name="ux_txt_filters_border_style[]" id="ux_txt_filter_border_style_color" onblur="default_value_gallery_master('#ux_txt_filter_border_style_color', '#9e9e9e');" onfocus="color_picker_gallery_master(this, this.value)" placeholder="<?php echo $gm_color_placeholder; ?>" value="<?php echo esc_attr($filter_border_color[2]); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <label class="control-label">
                              ...
                              <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_filter_border_hover_color_tooltip; ?>" data-placement="right"></i>
                              <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                           </label>
                           <input type="text" class="form-control" name="ux_txt_filters_border_hover_color" id="ux_txt_filters_border_hover_color"  placeholder="<?php echo $gm_global_option_filter_border_hover_color_placeholder; ?>" onblur="default_value_gallery_master('#ux_txt_filters_border_hover_color', '#2fbfc1');" onfocus="color_picker_gallery_master(this, this.value)" value="<?php echo isset($filter_settings_get_data["filters_border_hover_color"]) ? esc_attr($filter_settings_get_data["filters_border_hover_color"]) : "#000000" ?>">
                        </div>
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_filters_padding_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_filters_padding[]" id="ux_txt_filters_padding_top" placeholder="<?php echo $gm_top; ?>" onblur="default_value_gallery_master('#ux_txt_filters_padding_top', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($padding[0]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_filters_padding[]" id="ux_txt_filters_padding_right" placeholder="<?php echo $gm_right; ?>" onblur="default_value_gallery_master('#ux_txt_filters_padding_right', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($padding[1]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_filters_padding[]" id="ux_txt_filters_padding_bottom" placeholder="<?php echo $gm_bottom; ?>" onblur="default_value_gallery_master('#ux_txt_filters_padding_bottom', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($padding[2]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_filters_padding[]" id="ux_txt_filters_padding_left" placeholder="<?php echo $gm_left; ?>" onblur="default_value_gallery_master('#ux_txt_filters_padding_left', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($padding[3]); ?>">
                                 </div>
                              </div>
                           </div>
                        </div>
