   ...
   if (!$access_granted) {
      ...
      <div class="page-bar">
         <ul class="page-breadcrumb">
            ...
            <li>
               <span>
                  <?php echo $gm_watermark_settings; ?>
               </span>
            </li>
         </ul>
      </div>
                     ...
                     <div class="form-body">
                        ...
                        <div class="form-group">
                           <label class="control-label">
                              <?php echo $gm_watermark_settings_type_title; ?> :
                              <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_watermark_settings_type_tooltip; ?>" data-placement="right"></i>
                        ...
                        <div id="ux_div_watermark_text" style="display:none;">
                           <div class="form-group">
                              <label class="control-label">
                                 <?php echo $gm_watermark_settings_text_title; ?> :
                                 <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_watermark_settings_text_tooltip; ?>" data-placement="right"></i>
                                 <span class="required" aria-required="true">* <?php echo " (" . $gm_premium_edition . " )" ?></span>
                              </label>
                              <input type="text" class="form-control" name="ux_txt_watermark_text" id="ux_txt_watermark_text"  placeholder="<?php echo $gm_watermark_settings_text_placeholder; ?>" value="<?php echo isset($watermark_settings_get_data["watermark_settings_text"]) ? esc_attr($watermark_settings_get_data["watermark_settings_text"]) : ""; ?>">
                           </div>
                        </div>
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-icon right">
                                       <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_font[]" id="ux_txt_size" placeholder="<?php echo $gm_font_size_placeholder; ?>" onblur="default_value_gallery_master('#ux_txt_size', 20)" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($watermark_settings_font_style[0]); ?>">
                                       <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_font[]" id="ux_txt_color" onblur="default_value_gallery_master('#ux_txt_color', '#cccccc')" onfocus="color_picker_gallery_master(this, this.value)"   placeholder="<?php echo $gm_color_placeholder; ?>" value="<?php echo esc_attr($watermark_settings_font_style[1]); ?>">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label class="control-label">
                                       <?php echo $gm_watermark_settings_rotate_title; ?> :
                                       <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_watermark_settings_rotate_tooltip; ?>" data-placement="right"></i>
                                       <span class="required" aria-required="true">* <?php echo " (" . $gm_premium_edition . " )" ?></span>
                                    </label>
                                    <input class="form-control" name="ux_txt_watermark_angle" id="ux_txt_watermark_angle"  onkeypress="only_digits_gallery_master(event);" placeholder="<?php echo $gm_watermark_setting_text_angle_placeholder; ?>" value="<?php echo isset($watermark_settings_get_data["watermark_setting_angle"]) ? intval($watermark_settings_get_data["watermark_setting_angle"]) : 0; ?>" onblur="default_value_gallery_master('#ux_txt_watermark_angle', 0)" type="text">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div id="ux_div_watermark_image" style="display: none">
                           <div class="form-group">
                              <label class="control-label">
                                 <?php echo $gm_watermark_settings_watermark_url_title; ?> :
                                 <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_watermark_settings_url_tooltip; ?>" data-placement="right"></i>
                                 <span class="required" aria-required="true">* <?php echo " (" . $gm_premium_edition . " )" ?></span>
                              </label>
                              <input class="form-control custom-input-large input-inline" name="ux_txt_watermark_url" id="ux_txt_watermark_url"  placeholder="<?php echo $gm_url_placeholder; ?>" value="<?php echo isset($watermark_settings_get_data["watermark_settings_url"]) ? $watermark_settings_get_data["watermark_settings_url"] : ""; ?>" type="text">
                           ...
                           <div class="form-group">
                              <label class="control-label">
                                 <?php echo $gm_watermark_settings_size_title; ?> :
                                 <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_watermark_settings_size_tooltip; ?>" data-placement="right"></i>
                                 <span class="required" aria-required="true">* <?php echo " (" . $gm_premium_edition . " )" ?></span>
                              </label>
                              <input type="text" class="form-control" name="ux_txt_watermark_size" id="ux_txt_watermark_size"  placeholder="<?php echo $gm_watermark_settings_size_placeholder; ?>" onchange="check_opacity_gallery_master(this)" maxlength="3" onkeypress="only_digits_gallery_master(event);"  onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo isset($watermark_settings_get_data["watermark_settings_size"]) ? intval($watermark_settings_get_data["watermark_settings_size"]) : ""; ?>" >
                           </div>
                        </div>
                        <div id="ux_div_settings" style="display: none">
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label class="control-label">
                                       <?php echo $gm_watermark_settings_offset_title; ?> :
                                       <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_watermark_settings_offset_tooltip; ?>" data-placement="right"></i>
                                       <span class="required" aria-required="true">* <?php echo " (" . $gm_premium_edition . " )" ?></span>
                                    </label>
                                    <div class="input-icon right">
                                       <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_offset[]" id="ux_txt_offset_x" placeholder="<?php echo $gm_watermark_settings_offset_x_placeholder; ?>" onblur="default_value_gallery_master('#ux_txt_offset_x', 0)" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($watermark_setting_offset[0]); ?>">
                                       <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_offset[]" id="ux_txt_offset_y" placeholder="<?php echo $gm_watermark_settings_offset_y_placeholder; ?>" onblur="default_value_gallery_master('#ux_txt_offset_y', 0)" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($watermark_setting_offset[1]); ?>">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label class="control-label">
                                       <?php echo $gm_watermark_settings_opacity_title; ?> :
                                       <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_watermark_settings_opacity_tooltip; ?>" data-placement="right"></i>
                                       <span class="required" aria-required="true">* <?php echo " (" . $gm_premium_edition . " )" ?></span>
                                    </label>
                                    <div class="input-icon right">
                           ...
                           <div class="form-group">
                              <label class="control-label">
                                 <?php echo $gm_watermark_settings_position_title; ?> :
                                 <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_watermark_settings_position_tooltip; ?>" data-placement="right"></i>
                                 <span class="required" aria-required="true">* <?php echo " (" . $gm_premium_edition . " )" ?></span>
                              </label>
