                     ...
                     <div class="form-body">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_order_by_font_family_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gm_global_option_active_font_color; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_active_font_color_tooltips; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control" name="ux_txt_order_by_active_font_color" id="ux_txt_order_by_active_font_color" onblur="default_value_gallery_master('#ux_txt_order_by_active_font_color', '#2fbfc1')" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo $gm_global_option_active_font_color_placeholder; ?>" value="<?php echo isset($orderby_settings_get_data["order_by_active_font_color"]) ? esc_attr($orderby_settings_get_data["order_by_active_font_color"]) : "#2fbfc1"; ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_active_font_hover_color_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <input type="text" class="form-control" name="ux_txt_global_order_by_active_font_hover_color" id="ux_txt_global_order_by_active_font_hover_color" onblur="default_value_gallery_master('#ux_txt_global_order_by_active_font_hover_color', '#2fbfc1')" placeholder="<?php echo $gm_global_option_active_font_hover_color_placeholder; ?>"  onfocus="color_picker_gallery_master(this, this.value)" value="<?php echo isset($orderby_settings_get_data["order_by_active_font_hover_color"]) ? esc_attr($orderby_settings_get_data["order_by_active_font_hover_color"]) : "#2fbfc1"; ?>">
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gm_global_option_filter_background_color; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_order_by_background_color_tooltips; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_order_by_background_controls[]" id="ux_txt_global_option_order_by_background_color" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo $gm_global_option_background_color; ?>" value="<?php echo esc_attr($order_by_background_color_controls[0]); ?>">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_order_by_background_controls[]" id="ux_txt_global_option_order_by_background_color_transparency" placeholder="<?php echo $gm_global_option_background_color_transparency; ?>" onblur="default_value_gallery_master('#ux_txt_global_option_order_by_background_color_transparency', 100)" maxlength="3" onkeypress="only_digits_gallery_master(event);" onchange="check_opacity_gallery_master(this);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($order_by_background_color_controls[1]); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gm_global_option_background_hover_color; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_filter_background_hover_color_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <input type="text" class="form-control" name="ux_txt_order_by_background_hover_color" id="ux_txt_order_by_background_hover_color" placeholder="<?php echo $gm_global_option_filter_background_hover_color_placeholder; ?>"  onfocus="color_picker_gallery_master(this, this.value)" value="<?php echo isset($orderby_settings_get_data["order_by_background_hover_color"]) ? esc_attr($orderby_settings_get_data["order_by_background_hover_color"]) : ""; ?>">
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_order_by_border_style_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control input-width-25 input-inline" name="ux_txt_order_by_border_style[]" id="ux_txt_order_by_border_style_width" placeholder="<?php echo $gm_width_placeholder; ?>" onblur="default_value_gallery_master('#ux_txt_order_by_border_style_width', 2)" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($order_by_border_color[0]); ?>">
                                    ...
                                    <input type="text" class="form-control input-normal input-inline" name="ux_txt_order_by_border_style[]" id="ux_txt_order_by_border_style_color" onblur="default_value_gallery_master('#ux_txt_order_by_border_style_color', '#9e9e9e')" onfocus="color_picker_gallery_master(this, this.value)" placeholder="<?php echo $gm_color_placeholder; ?>" value="<?php echo esc_attr($order_by_border_color[2]); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_order_by_border_radius_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control" name="ux_txt_order_by_border_radius" id="ux_txt_order_by_border_radius" placeholder="<?php echo $gm_border_radius_placeholder; ?>" maxlength="3" onkeypress="only_digits_gallery_master(event);" onblur="default_value_gallery_master('#ux_txt_order_by_border_radius', 0)" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo isset($orderby_settings_get_data["order_by_border_radius"]) ? intval($orderby_settings_get_data["order_by_border_radius"]) : 0 ?>">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                           <label class="control-label">
                              ...
                              <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_order_by_border_hover_color_tooltip; ?>" data-placement="right"></i>
                              <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                           </label>
                           <input type="text" class="form-control" name="ux_txt_order_by_border_hover_color" id="ux_txt_order_by_border_hover_color" onblur="default_value_gallery_master('#ux_txt_order_by_border_hover_color', '#2fbfc1')"  placeholder="<?php echo $gm_global_option_filter_border_hover_color_placeholder; ?>" onfocus="color_picker_gallery_master(this, this.value)" value="<?php echo isset($orderby_settings_get_data["order_by_border_hover_color"]) ? esc_attr($orderby_settings_get_data["order_by_border_hover_color"]) : "#2fbfc1" ?>">
                        </div>
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_order_by_margin_tooltip; ?>" data-placement="right" ></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    ...
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_order_by_margin[]" id="ux_txt_order_by_margin_right" placeholder="<?php echo $gm_right; ?>" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onblur="default_value_gallery_master('#ux_txt_order_by_margin_right', 5);" value="<?php echo intval($order_by_margin[1]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_order_by_margin[]" id="ux_txt_order_by_margin_bottom" placeholder="<?php echo $gm_bottom; ?>" onblur="default_value_gallery_master('#ux_txt_order_by_margin_bottom', 20);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($order_by_margin[2]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_order_by_margin[]" id="ux_txt_order_by_margin_left" placeholder="<?php echo $gm_left; ?>" onblur="default_value_gallery_master('#ux_txt_order_by_margin_left', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($order_by_margin[3]); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_order_by_padding_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_order_by_padding[]" id="ux_txt_order_by_padding_top" placeholder="<?php echo $gm_top; ?>" onblur="default_value_gallery_master('#ux_txt_order_by_padding_top', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($order_by_padding[0]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_order_by_padding[]" id="ux_txt_order_by_padding_right" placeholder="<?php echo $gm_right; ?>" onblur="default_value_gallery_master('#ux_txt_order_by_padding_right', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($order_by_padding[1]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_order_by_padding[]" id="ux_txt_order_by_padding_bottom" placeholder="<?php echo $gm_bottom; ?>" onblur="default_value_gallery_master('#ux_txt_order_by_padding_bottom', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($order_by_padding[2]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_order_by_padding[]" id="ux_txt_order_by_padding_left" placeholder="<?php echo $gm_left; ?>" onblur="default_value_gallery_master('#ux_txt_order_by_padding_left', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($order_by_padding[3]); ?>">
                                 </div>
                              </div>
                           </div>
                        </div>
