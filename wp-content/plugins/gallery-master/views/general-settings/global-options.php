                     ...
                     <div class="form-body">
                           ...
                           <div class="col-md-6" style="margin-bottom:15px;">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gm_global_options_generated_image_dimension_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_options_generated_image_dimension_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">*</span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_height_width[]" id="ux_txt_width" placeholder="<?php echo $gm_width_layout_placeholder; ?>" maxlength="4" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onblur="check_thumbnail_dimension_gallery_master(this, '#ux_txt_thumbnail_width');" value="<?php echo intval($global_options_generated_image_dimensions[0]); ?>">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_height_width[]" id="ux_txt_height" placeholder="<?php echo $gm_height_placeholder; ?>" maxlength="4" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onblur="check_thumbnail_dimension_gallery_master(this, '#ux_txt_thumbnail_height');" value="<?php echo intval($global_options_generated_image_dimensions[1]); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6" style="margin-bottom:15px;">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gm_global_option_thumbnail_dimension_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_thumbnail_dimension_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">*</span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_thumbnail_height_width[]" id="ux_txt_thumbnail_width" placeholder="<?php echo $gm_width_layout_placeholder; ?>" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onblur="check_thumbnail_dimension_gallery_master(this, '#ux_txt_width')" value="<?php echo intval($global_options_thumbnail_dimensions[0]); ?>">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_thumbnail_height_width[]" id="ux_txt_thumbnail_height" placeholder="<?php echo $gm_height_placeholder; ?>" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onblur="check_thumbnail_dimension_gallery_master(this, '#ux_txt_height')" value="<?php echo intval($global_options_thumbnail_dimensions[1]); ?>">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="row" style="margin-bottom:15px;">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gm_global_option_right_click_protection_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_right_click_protection_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">*</span>
                                 </label>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gm_global_option_language_direction_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_language_direction_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">*</span>
                                 </label>
                                 <select name="ux_ddl_language_direction" id="ux_ddl_language_direction" class="form-control">
                                    <option value="right_to_left"><?php echo $gm_global_option_language_direction_right_to_left; ?></option>
                                    <option value="left_to_right"><?php echo $gm_global_option_language_direction_left_to_right; ?></option>
                                 </select>
                              </div>
                           </div>
                        </div>
