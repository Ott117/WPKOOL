   ...
   if (!$access_granted) {
      ...
      <div class="page-bar">
         <ul class="page-breadcrumb">
            ...
            <li>
               <span>
                  <?php echo $gm_search_box_settings; ?>
               </span>
            </li>
         </ul>
      </div>
                     ...
                     <div class="form-body">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_search_box_font_style_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_search_box_font_style_color[]" id="ux_txt_search_box_font_style" placeholder="<?php echo $gm_font_size_placeholder; ?>" onblur="default_value_gallery_master('#ux_txt_search_box_font_style', 14)" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($search_box_font_style[0]); ?>">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_search_box_font_style_color[]" id="ux_txt_search_font_color"  onblur="default_value_gallery_master('#ux_txt_search_font_color', '#000000')" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo $gm_color_placeholder; ?>" value="<?php echo esc_attr($search_box_font_style[1]); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_search_box_font_family_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_search_box_background_color_tooltips; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_search_box_background_controls[]" id="ux_txt_global_option_search_box_background_color" onfocus="color_picker_gallery_master(this, this.value)"  placeholder="<?php echo $gm_global_option_background_color; ?>" value="<?php echo esc_attr($search_box_background_color_controls[0]); ?>">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_search_box_background_controls[]" id="ux_txt_global_option_search_box_background_color_transparency" placeholder="<?php echo $gm_global_option_background_color_transparency; ?>" onblur="default_value_gallery_master('#ux_txt_global_option_search_box_background_color_transparency', 100)" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onchange="check_opacity_gallery_master(this);" value="<?php echo intval($search_box_background_color_controls[1]); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_search_border_style_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control input-width-25 input-inline" name="ux_txt_search_by_border_style[]" id="ux_txt_filter_border_style_width" placeholder="<?php echo $gm_width_placeholder; ?>" onblur="default_value_gallery_master('#ux_txt_filter_border_style_width', 2)" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($search_box_border_color[0]); ?>">
                                    ...
                                    <input type="text" class="form-control input-normal input-inline" name="ux_txt_search_by_border_style[]" id="ux_txt_search_by_border_style_color" onblur="default_value_gallery_master('#ux_txt_search_by_border_style_color', '#9e9e9e')" onfocus="color_picker_gallery_master(this, this.value)" placeholder="<?php echo $gm_color_placeholder; ?>" value="<?php echo esc_attr($search_box_border_color[2]); ?>">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                           <label class="control-label">
                              ...
                              <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_global_option_search_border_radius_tooltip; ?>" data-placement="right"></i>
                              <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                           </label>
                           <div class="input-icon right">
                              <input type="text" class="form-control" name="ux_txt_search_by_border_radius" id="ux_txt_search_by_border_radius" placeholder="<?php echo $gm_border_radius_placeholder; ?>" maxlength="3" onkeypress="only_digits_gallery_master(event);" onblur="default_value_gallery_master('#ux_txt_search_by_border_radius', 0)" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo isset($searchbox_settings_get_data["search_box_border_radius"]) ? intval($searchbox_settings_get_data["search_box_border_radius"]) : 0; ?>">
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_search_box_margin_tooltip; ?>" data-placement="right" ></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_search_box_margin[]" id="ux_txt_search_box_margin_top" placeholder="<?php echo $gm_top; ?>" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onblur="default_value_gallery_master('#ux_txt_search_box_margin_top', 0);" value="<?php echo intval($search_box_margin[0]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_search_box_margin[]" id="ux_txt_search_box_margin_right" placeholder="<?php echo $gm_right; ?>" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onblur="default_value_gallery_master('#ux_txt_search_box_margin_right', 5);" value="<?php echo intval($search_box_margin[1]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_search_box_margin[]" id="ux_txt_search_box_margin_bottom" placeholder="<?php echo $gm_bottom; ?>" onblur="default_value_gallery_master('#ux_txt_search_box_margin_bottom', 20);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($search_box_margin[2]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_search_box_margin[]" id="ux_txt_search_box_margin_left" placeholder="<?php echo $gm_left; ?>" onblur="default_value_gallery_master('#ux_txt_search_box_margin_left', 0);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($search_box_margin[3]); ?>">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    ...
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_search_box_padding_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_search_box_padding[]" id="ux_txt_search_box_padding_top" placeholder="<?php echo $gm_top; ?>" onblur="default_value_gallery_master('#ux_txt_search_box_padding_top', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($search_box_padding[0]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_search_box_padding[]" id="ux_txt_search_box_padding_right" placeholder="<?php echo $gm_right; ?>" onblur="default_value_gallery_master('#ux_txt_search_box_padding_right', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($search_box_padding[1]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_search_box_padding[]" id="ux_txt_search_box_padding_bottom" placeholder="<?php echo $gm_bottom; ?>" onblur="default_value_gallery_master('#ux_txt_search_box_padding_bottom', 5);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($search_box_padding[2]); ?>">
                                    <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_search_box_padding[]" id="ux_txt_search_box_padding_left" placeholder="<?php echo $gm_left; ?>" onblur="default_value_gallery_master('#ux_txt_search_box_padding_left', 10);" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" value="<?php echo intval($search_box_padding[3]); ?>">
                                 </div>
                              </div>
                           </div>
                        </div>
