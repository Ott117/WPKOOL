                     ...
                     <div class="form-body">
                        ...
                        <div class="form-group">
                           <label class="control-label">
                              ...
                              <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_sort_albums_choose_album_tooltip; ?>" data-placement="right"></i>
                           ...
                           <select name="ux_ddl_sort_albums" id="ux_ddl_sort_albums" class="form-control" onchange="choose_album_gallery_master(this.value);">
                              <option value=""><?php echo $gm_sort_albums_choose_album_title; ?></option>
                              <?php
                              foreach ($sort_albums_get_title as $value) {
                                 ?>
                                 <option value="<?php echo intval($value["meta_id"]); ?>"><?php echo isset($value["album_name"]) != "" ? esc_attr($value["album_name"]) : $gm_untitled_album; ?></option>
                                 <?php
                              }
                              ?>
                           </select>
