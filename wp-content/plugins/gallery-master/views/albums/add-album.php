   ...
   if (!$access_granted) {
      ...
      <div class="page-bar">
         <ul class="page-breadcrumb">
            ...
            <li>
               <span>
                  <?php echo isset($_REQUEST["album_id"]) ? $gm_update_album_title : $gm_add_album; ?>
               </span>
            </li>
         </ul>
      </div>
                              ...
                              <div class="tab-pane active" id="basic_details">
                                 <div class="form-group">
                                    <label class="control-label">
                                       ...
                                       <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_add_album_title_tooltip; ?>" data-placement="right"></i>
                                       <span class="required" aria-required="true">* <?php echo "( " . $gm_premium_edition . " )"; ?></span>
                                    </label>
                                    <textarea rows="1" class="form-control" name="ux_txt_album_title" id="ux_txt_album_title" placeholder="<?php echo $gm_add_album_title_placeholder; ?>"><?php echo isset($get_album_data_unserialize["album_name"]) ? esc_attr($get_album_data_unserialize["album_name"]) : ""; ?></textarea>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label">
                                       <?php echo $gm_album_description; ?> :
                                       <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_add_album_description_tooltip; ?>" data-placement="right"></i>
                                       <span class="required" aria-required="true"><?php echo "( " . $gm_premium_edition . " )"; ?></span>
                                    </label>
                                    <?php
                                    ...
                                    wp_editor($gm_album_description_data, "ux_heading_content", array('teeny' => TRUE, 'textarea_name' => 'description', 'media_buttons' => FALSE, 'textarea_rows' => 20));
                                    ?>
                                    <textarea name="ux_txtarea_album_heading_content" id="ux_txtarea_album_heading_content" style="display:none;"><?php echo $gm_album_description_data; ?></textarea>
                                 </div>
                              </div>
                              <div class="tab-pane" id="upload_local_media">
                                 <div class="row">
                                    <div class="col-md-5">
                                       <div class="form-group">
                                          <label class="control-label">
                                             <?php echo $gm_galleries_available; ?> :
                                             <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_galleries_available_tooltip; ?>" data-placement="right"></i>
                                             <span class="required" aria-required="true">* <?php echo "( " . $gm_premium_edition . " )"; ?></span>
                                          </label>
                                          <select class="form-control" multiple="multiple" name="ux_ddl_available_galleries_duplicate" id="ux_ddl_available_galleries_duplicate" style="height:300px">
                                             ...
                                             foreach ($get_galleries_data_for_album as $value) {
                                                if (!in_array(intval($value["meta_id"]), $seleted_countries_array)) {
                                                   ?>
                                                   <option value="<?php echo intval($value["meta_id"]); ?>"><?php echo $value["gallery_title"] != "" ? esc_attr($value["gallery_title"]) : $gm_untitled; ?></option>
                                                   <?php
                                                }
                                             }
                                             ?>
                                    ...
                                    <div class="col-md-2">
                                       <div class="custom-button-gallery">
                                          <div class="form-actions">
                                             <input type="button" class="btn vivid-green" id="ux_btn_add_gallery" name="ux_btn_add_gallery" value="<?php echo $gm_add_gallery_button . " >>"; ?>" onclick="add_gallery_gallery_master();" style="width:100px">
                                          </div>
                                          <div class="form-action">
                                             <input type="button" class="btn vivid-green" id="ux_btn_delete_gallery" name="ux_btn_delete_gallery" value="<?php echo "<< " . $gm_remove_gallery_button; ?>" onclick="remove_gallery_gallery_master();" style="width:100px">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-5">
                                       <div class="form-group">
                                          <label class="control-label">
                                             <?php echo $gm_galleries_included_in_this_album; ?> :
                                             <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_galleries_included_in_this_album_tooltip; ?>" data-placement="right"></i>
                                             <span class="required" aria-required="true">* <?php echo "( " . $gm_premium_edition . " )"; ?></span>
                                          </label>
