                  ...
                  <form id="ux_frm_thumbnail_layout_shortcode">
                     <div class="form-body">
                        ...
                        <div class="form-group">
                           ...
                           <select id="ux_ddl_choose_gallery" name="ux_ddl_choose_gallery" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_alignment" id="ux_ddl_alignment" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_lightbox_type" id="ux_ddl_lightbox_type" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_page_navigation" id="ux_ddl_page_navigation" class="form-control" onchange="show_hide_control_gallery_master('ux_ddl_page_navigation', 'ux_div_no_of_images'); generate_shortcode_thumbnail_layout_gallery_master();">
                        ...
                        <div class="form-group" id="ux_div_no_of_images" style="display:none;">
                           ...
                           <input type="text" class="form-control" name="ux_txt_images_per_page" id="ux_txt_images_per_page" value="10" maxlength="3" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onblur="default_value_gallery_master('#ux_txt_images_per_page', 10); generate_shortcode_thumbnail_layout_gallery_master();" placeholder="<?php echo $gm_no_of_image_per_page_placeholder; ?>">
                        </div>
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_gallery_title" name="ux_ddl_gallery_title" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_gallery_description" id="ux_ddl_gallery_description" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                                       <option value="show"><?php echo $gm_show; ?></option>
                                       <option value="hide"><?php echo $gm_hide; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_thumbnail_title" name="ux_ddl_thumbnail_title" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                                    <option value="show"><?php echo $gm_show; ?></option>
                                    <option value="hide"><?php echo $gm_hide; ?></option>
                                 </select>
                              </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_thumbnail_description" id="ux_ddl_thumbnail_description" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                                       <option value="show"><?php echo $gm_show; ?></option>
                                       <option value="hide"><?php echo $gm_hide; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_sort_image_by" id="ux_ddl_sort_image_by" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_order_images" id="ux_ddl_order_images" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_lazy_load" id="ux_ddl_lazy_load" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                                       <option value="disable"><?php echo $gm_disable; ?></option>
                                       <option value="enable" disabled="disabled"><?php echo $gm_enable; ?></option>
                                    </select>
                                 </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_filters" id="ux_ddl_filters" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                                       <option value="disable"><?php echo $gm_disable; ?></option>
                                       <option value="enable" disabled="disabled"><?php echo $gm_enable; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_order_by" id="ux_ddl_order_by" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                                       <option value="disable"><?php echo $gm_disable; ?></option>
                                       <option value="enable" disabled="disabled"><?php echo $gm_enable; ?></option>
                                    </select>
                                 </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_search_box" id="ux_ddl_search_box" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                                       <option value="disable"><?php echo $gm_disable; ?></option>
                                       <option value="enable" disabled="disabled"><?php echo $gm_enable; ?></option>
                                    </select>
                                 </div>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <select id="ux_ddl_animation_effect" name="ux_ddl_animation_effect" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-icon right">
                                       <select id="ux_ddl_special_effects" name="ux_ddl_special_effects" class="form-control" onchange="generate_shortcode_thumbnail_layout_gallery_master();">
                                          <option value="none"><?php echo $gm_none; ?></option>
