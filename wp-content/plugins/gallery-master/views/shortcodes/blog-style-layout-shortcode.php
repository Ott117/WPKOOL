                     ...
                     <div class="form-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gm_blog_style_layout_blog_width_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_blog_style_layout_blog_width_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <input type="text" class="form-control" name="ux_txt_blog_style_thumbnail_width" id="ux_txt_blog_style_thumbnail_width" value="500" maxlength="4" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onblur="set_thumbnail_dimension_in_shortcode(this,<?php echo $image_dimensions[0] ?>, '<?php echo $gm_shortcode_blog_width_exceed_msg; ?>'); premium_edition_notification_gallery_master();" placeholder="<?php echo $gm_max_width_placeholder; ?>">
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_page_navigation" id="ux_ddl_page_navigation" class="form-control" onchange="show_hide_control_gallery_master('ux_ddl_page_navigation', 'ux_no_of_images_per_page'); premium_edition_notification_gallery_master();">
