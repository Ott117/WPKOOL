                     ...
                     <div class="form-body">
                        ...
                        <div id="ux_div_justified_shortcode" class="ux_div_justified_shortcode" style="display:none;">
                           <div class="form-group">
                              ...
                              <div class="icon-custom-docs tooltips pull-right" style="font-size:18px;" data-original-title="<?php echo $gm_copy_to_clipboard; ?>" data-placement="left" data-clipboard-action="copy" data-clipboard-target="#ux_txtarea_justified_generate_shortcode"></div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_choose_type" name="ux_ddl_choose_type" class="form-control" onchange="shortcode_source_type_control_gallery_master('ux_ddl_choose_type', 'ux_div_gallery', 'ux_div_album', 'ux_div_show_hide_album'); premium_edition_notification_gallery_master();">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gm_justified_grid_shortcode_row_height ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_justified_grid_shortcode_row_height_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control input-inline" name="ux_txt_row_height" id="ux_txt_row_height" placeholder="<?php echo $gm_justified_grid_shortcode_row_height_placeholder; ?>"  maxlength="3" onkeypress="digits_with_dot_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onblur="default_value_gallery_master('#ux_txt_row_height', 150); premium_edition_notification_gallery_master();" value="150">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <div class="input-icon right">
                                    <select name="ux_ddl_lightbox_type" id="ux_ddl_lightbox_type" class="form-control" onchange="premium_edition_notification_gallery_master();">
                                       <option value="no_lightbox"><?php echo $gm_no_light_box; ?></option>
                                       <option selected="selected" value="lightcase"><?php echo $gm_lightcase; ?></option>
                                       <option value="fancy_box"><?php echo $gm_fancy_box; ?></option>
                                       <option value="color_box"><?php echo $gm_color_box; ?></option>
                                       ...
                                       <option value="nivo_lightbox"><?php echo $gm_nivo_lightbox; ?></option>
                                    </select>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_page_navigation" id="ux_ddl_page_navigation" class="form-control" onchange="show_hide_control_gallery_master('ux_ddl_page_navigation', 'ux_div_no_of_images'); premium_edition_notification_gallery_master();">
                        ...
                        <div class="form-group" id="ux_div_no_of_images" style="display:none;">
                           ...
                           <input type="text" class="form-control" name="ux_txt_justified_images_per_page" id="ux_txt_justified_images_per_page" value="10" maxlength="3" onblur="default_value_gallery_master('#ux_txt_justified_images_per_page', 10); premium_edition_notification_gallery_master();" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" placeholder="<?php echo $gm_no_of_image_per_page_placeholder; ?>">
                        </div>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <select id="ux_ddl_album_title" name="ux_ddl_album_title" class="form-control" onchange="premium_edition_notification_gallery_master();">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label class="control-label">
                                       ...
                                       <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_album_description_tooltip; ?>" $gm_choose_album_type_tooltipdata-placement="right"></i>
                                       <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                    </label>
                                    <select id="ux_ddl_album_description" name="ux_ddl_album_description" class="form-control" onchange="premium_edition_notification_gallery_master();">
                                       <option value="show"><?php echo $gm_show; ?></option>
                                       <option value="hide"><?php echo $gm_hide; ?></option>
                                    </select>
                                 </div>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_justified_sort_image_by" id="ux_ddl_justified_sort_image_by" class="form-control" onchange="premium_edition_notification_gallery_master();">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select name="ux_ddl_justified_order_images" id="ux_ddl_justified_order_images" class="form-control" onchange="premium_edition_notification_gallery_master();">
                                    <option value="sort_asc"><?php echo $gm_ascending; ?></option>
                                    <option value="sort_desc"><?php echo $gm_descending; ?></option>
                                 </select>
                              </div>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <div class="input-icon right">
                                       <select id="ux_ddl_justified_special_effects" name="ux_ddl_justified_special_effects" class="form-control" onchange="premium_edition_notification_gallery_master();">
                                          <option value="none"><?php echo $gm_none; ?></option>
                        ...
                        <div id="ux_div_justified_shortcode" class="ux_div_justified_shortcode" style="display:none;">
                           <div class="form-group">
                              ...
                              <div class="icon-custom-docs tooltips pull-right" style="font-size:18px;" data-original-title="<?php echo $gm_copy_to_clipboard; ?>" data-placement="left" data-clipboard-action="copy" data-clipboard-target="#ux_txtarea_justified_generate_shortcodes"></div>
