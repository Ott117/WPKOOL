...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      return;
   } else if (shortcode_generator_gallery_master == "1") {
                     ...
                     <div class="form-body">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gm_image_browser_layout_image_browser_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gm_image_browser_layout_image_browser_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo "(" . $gm_premium_edition . ")"; ?></span>
                                 </label>
                                 <div class= "input-icon right">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_width" id="ux_txt_width" value="800" maxlength="4" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);" onblur="set_thumbnail_dimension_in_shortcode_gallery_master(this,<?php echo $image_dimensions[0] ?>, '<?php echo $gm_shortcode_image_dimensions_exceed_msg; ?>'); premium_edition_notification_gallery_master();" placeholder="<?php echo $gm_max_width_placeholder; ?>">
                                    <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_height" id="ux_txt_height" value="500" maxlength="4" onkeypress="only_digits_gallery_master(event);" onfocus="paste_prevent_gallery_master(this.id);"  onblur="set_thumbnail_dimension_in_shortcode_gallery_master(this,<?php echo $image_dimensions[1] ?>, '<?php echo $gm_shortcode_image_dimensions_exceed_msg; ?>'); premium_edition_notification_gallery_master();" placeholder="<?php echo $gm_max_height_placeholder; ?>">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                           ...
                           <select name="ux_ddl_button_text" id="ux_ddl_button_text" class="form-control" onchange="premium_edition_notification_gallery_master();">
