=== Gallery Master - Photo Albums, Photo Gallery, Image Gallery, Portfolio, WordPress Gallery Plugin ===
...
Donate link: https://gallery-master.tech-banker.com/
...
Gallery Plugin that can be used to create a gallery widget, media gallery, image gallery, portfolio gallery and photo albums.

== Description =

**This plugin is the ideal solution for creating portfolios, galleries, albums, showcases or teasers.**

* **[Gallery Master - Responsive Image Gallery Plugin](https://gallery-master.tech-banker.com/)**
* **[Detailed Features - Responsive Photo Gallery Plugin](http://gallery-master.tech-banker.com/features/detailed-features/)**
* **[Front End Demos - Gallery Plugin](https://gallery-master.tech-banker.com/frontend-demos/)**
* **[Back End Demos- Best WordPress Gallery Plugin](https://gallery-master.tech-banker.com/backend-demos/)**
* **[Documentation - Best Photo Gallery WordPress Plugin](https://gallery-master.tech-banker.com/documentation/)**
* **[Upgrade to Premium Editions - Photo Gallery Plugin for WordPress](https://gallery-master.tech-banker.com/pricing/)**

### [Wordpress Gallery Plugin](https://gallery-master.tech-banker.com/)

**[Gallery Master](https://gallery-master.tech-banker.com/)** is the ultimate **photo gallery plugin** for WordPress.
...
#### WORDPRESS PHOTO GALLERY PLUGIN – LIVE DEMOS

> * **[Thumbnail Layout - WordPress Image Gallery Plugin](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-description-thumbnail-layout/)**
> * **[Masonry Gallery - WordPress Image Gallery Plugin](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-description-masonry-layout/)**
> * **[Slideshow Gallery - WordPress Image Gallery Plugin](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-description-slideshow-layout/)**
> * **[Image Browser Layout - WordPress Image Gallery Plugin](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-description-image-browser-layout/)**
> * **[Justified Grid Layout - WordPress Image Gallery Plugin](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-description-justified-grid-layout/)**
> * **[Blog Style Layout - WordPress Image Gallery Plugin](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-description-blog-style-layout/)**
> * **[Photo Albums using Compact Album Layout - WordPress Image Gallery Plugin](https://gallery-master.tech-banker.com/frontend-demos/compact-album-with-title-description-thumbnail-layout/)**
> * **[Photo Albums using Extended Album Layout - WordPress Image Gallery Plugin](https://gallery-master.tech-banker.com/frontend-demos/extended-album-with-title-description-thumbnail-layout/)**

### Best Wordpress Gallery

**[Gallery Master](https://gallery-master.tech-banker.com/)** is an advanced **portfolio** plugin which combines all you need to work with your image collection in one single place. Images can be organized into **galleries** and **albums**.
...
### EXCELLENT FEATURES OF [GALLERY MASTER](http://gallery-master.tech-banker.com/features/detailed-features/)
...
* [Thumbnail Layout](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-thumbnail-layout/): This responsive gallery plugin have customizable options for you as thumbnails size, width, height, border, text, heading and description. You can choose between original or custom settings for thumbnail size.
* [Masonry Layout](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-masonry-layout/): You can implement masonry layout with this best wordpress photo gallery plugin. Masonry Layouts are a great choice for creating galleries using images with varied dimensions.
* [Slideshow Layout](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-slideshow-layout/): Mobile-Friendly, non-flash slideshows with nice transitions makes Gallery Master the best gallery plugin for wordpress. It gives you the best feature i.e. slideshow which is flexible, all aspects can easily be configured and embedding the responsive gallery.
* [Image Browser Layout](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-image-browser-layout/): Image Browser Layout displays larger size thumbnail with a navigation possibility so that you can easily move forward and backward in gallery. It can be used for saving space of displaying all images within a page. It gives you an image gallery with clean, crisp edges.
* [Justified Grid Layout](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-justified-grid-layout/): This wordpress photo gallery plugin allows you to display your photos in a Justified Grid Layout. This responsive gallery plugin allows you to represent your images within your created gallery next to each other without padding between them. You can easily drag and drop the images to control where they appear.
* [Blog Style Layout](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-title-blog-style-layout/): The Blog Style Gallery works with images of any size or orientation in the same gallery. With blog style gallery, you can also add title and description to each image using gallery lightbox. Using Gallery Master with Blog Style Gallery views is the simplest and most understanding way to show your content within gallery.

**GALLERY LIGHTBOXES**

* [Lightcase](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-lightboxes-thumbnail-layout/lightcase/)
* [Fancy Box](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-lightboxes-thumbnail-layout/fancy-box/)
* [Color Box](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-lightboxes-thumbnail-layout/color-box/)
* [Foo Box](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-lightboxes-thumbnail-layout/foo-box/)
* [Nivo Lightbox](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-lightboxes-thumbnail-layout/nivo-lightbox/)


**ANIMATION EFFECTS**

* [Magic Effects](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/magic-effects/)
* [Bling](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/bling/)
* [Static Effects](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/static-effects/)
* [Perspective](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/perspective/)
* [Slide](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/slide/)
* [Math](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/math/)
* [Tin](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/tin/)
* [Boing](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/boing/)
* [On the Space](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/on-the-space/)
* [Attention Seekers](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/attention-seekers/)
* [Bouncing Entrances](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/bouncing-entrances/)
* [Fading Entrances](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/fading-entrances/)
* [Flippers](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/flippers/)
* [Lightspeed](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/lightspeed/)
* [Rotating Entrances](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/rotating-entrances/)
* [Sliding Entrances](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/sliding-entrances/)
* [Zoom Entrances](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/zoom-entrances/)
* [Specials](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-animation-thumbnail-layout/specials/)

**SPECIAL EFFECTS**

* [Blur](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-special-effects-thumbnail-layout/blur/)
* [Sepia](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-special-effects-thumbnail-layout/sepia/)
* [Brightness](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-special-effects-thumbnail-layout/brightness/)
* [Contrast](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-special-effects-thumbnail-layout/contrast/)
* [Invert](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-special-effects-thumbnail-layout/invert/)
* [Saturate](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-special-effects-thumbnail-layout/saturate/)
* [Grayscale](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-special-effects-thumbnail-layout/grayscale/)
* [Hue Rotate](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-special-effects-thumbnail-layout/hue-rotate/)

**ADVANCED OPTIONS**

* [Pagination](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-pagination-thumbnail-layout/)
* [Lazy Load](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-lazy-load-thumbnail-layout/)
* [Filters](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-filters-thumbnail-layout/)
* [Order By](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-order-by-thumbnail-layout/)
* [Search Box](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-search-box-thumbnail-layout/)
* [Watermark](https://gallery-master.tech-banker.com/frontend-demos/individual-images-with-watermark-thumbnail-layout/)
