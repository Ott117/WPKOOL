...
<script type="text/javascript">
   ...
   /*
    Function Name: call_gallery_master_layout_type_
    Parameters: Yes(layout_type)
    Description: This function is used for Layouts.
    Created On: 03-6-2017 09:00AM
    Created By: Tech Banker Team
    */
   if (typeof (call_gallery_master_layout_type_<?php echo $random; ?>) !== "function")
   {
      function call_gallery_master_layout_type_<?php echo $random; ?>()
      {
<?php
...
?>
   ...
   /*
    Function Name: call_gallery_master_lightbox_
    Parameters: Yes(lightbox_type)
    Description: This function is used for Lightboxes.
    Created On: 01-6-2017 09:00AM
    Created By: Tech Banker Team
    */
   if (typeof (call_gallery_master_lightbox_<?php echo $random; ?>) !== "function")
   {
      function call_gallery_master_lightbox_<?php echo $random; ?>(lightbox_type)
      {
...
?>
   ...
   jQuery(document).ready(function ()
   {
      ...
      if (global_options_right_click_protection === "enable") {
         jQuery(".gallery_master_main_container").on("contextmenu", function (e)
         {
            return false;
         });
      }
      call_gallery_master_layout_type_<?php echo $random; ?>();
      call_gallery_master_lightbox_<?php echo $random; ?>("<?php echo $lightbox_type; ?>");
   });
</script>