...
/*
  Class Name: user_helper_gallery_master
  Parameters: No
...
if (!class_exists("user_helper_gallery_master")) {
   ...
   class user_helper_gallery_master {
      /*
        Function Name: get_unserialize_mode_data_gallery_master
      ...
      /*
        Function Name: hex2rgm_gallery_master
        Parameters: Yes($hex)
      ...
      /*
        Function Name: gallery_master_font_families
