   ...
   if (!$access_granted) {
      ...
      if ($flag == "1") {
         $wp_admin_bar->add_menu(array
             (
             "id" => "gallery_master",
             "title" => "<img style=\"width:16px; height:16px; vertical-align:middle; margin-right:3px;\" src=" . GALLERY_MASTER_PLUGIN_DIR_URL . "assets/global/img/icon.png" . "> " . $gallery_master,
         ...
         $wp_admin_bar->add_menu(array
             ...
             "href" => admin_url("admin.php?page=gm_thumbnail_layout_shortcode"),
         ));
         ...
         $wp_admin_bar->add_menu(array
             ...
             "parent" => "gallery_master",
             "id" => "gm_pricing_plans",
             "title" => $gm_pricing_plans,
             "href" => "https://gallery-master.tech-banker.com/pricing/",
             'meta' => array('target' => '_blank')
         ));
      }
   }
