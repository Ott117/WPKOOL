...
if (!is_user_logged_in()) {
    ...
    if (!current_user_can("manage_options")) {
        ...
        if (!class_exists("dbHelper_install_script_gallery_master")) {
            ...
            class dbHelper_install_script_gallery_master {
                /*
                ...
                function createThumbs_gallery_master($fname, $image_data) {
                    $fileName = wp_unique_filename(GALLERY_MASTER_THUMBS_CROPPED_DIR, $fname);
                    if (function_exists("wp_get_image_editor")) {
                        ...
                        if (!is_wp_error($image_original) || !is_wp_error($image_thumbnail_cropped) || !is_wp_error($image_thumbnail_non_cropped)) {
                            ...
                            $image_original->save(GALLERY_MASTER_ORIGINAL_DIR . $fileName);

                            $image_thumbnail_cropped->resize($image_data[2], $image_data[3], true);
                            $image_thumbnail_cropped->save(GALLERY_MASTER_THUMBS_CROPPED_DIR . $fileName);

                            $image_thumbnail_non_cropped->resize($image_data[2], $image_data[3], false);
                            $image_thumbnail_non_cropped->save(GALLERY_MASTER_THUMBS_NON_CROPPED_DIR . $fileName);
                        }
                    } else {
                        image_resize(GALLERY_MASTER_ORIGINAL_DIR . $fname, $image_data[0], $image_data[1], false);
                        image_resize(GALLERY_MASTER_THUMBS_CROPPED_DIR . $fname, $image_data[2], $image_data[3], true);
                        image_resize(GALLERY_MASTER_THUMBS_NON_CROPPED_DIR . $fname, $image_data[2], $image_data[3], false);
                    }
                    return $fileName;
                }

                function file_exif_information_gallery_master($file) {
        ...
        if (!function_exists("table_gallery_master_meta")) {
            ...
            function table_gallery_master_meta() {
                ...
                $parent_table_data = $wpdb->get_results
                        (
                        "SELECT id,type FROM " . gallery_master_parent()
                );
                ...
                foreach ($parent_table_data as $row) {
                    switch ($row->type) {
                        case "layout_settings":
                            ...
                            $thumbnail_layout_data["thumbnail_layout_gallery_title_font_family"] = "Lato:700";
                            ...
                            $thumbnail_layout_data["thumbnail_layout_gallery_description_font_family"] = "Lato:300";
                            ...
                            $thumbnail_layout_data["thumbnail_layout_thumbnail_title_font_family"] = "Lato:700";
                            ...
                            $thumbnail_layout_data["thumbnail_layout_thumbnail_description_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $thumbnail_layout_data_serialize);
                            ...
                            $masonry_layout_data["masonry_layout_gallery_title_font_family"] = "Lato:700";
                            ...
                            $masonry_layout_data["masonry_layout_gallery_description_font_family"] = "Lato:300";
                            ...
                            $masonry_layout_data["masonry_layout_thumbnail_title_font_family"] = "Lato:700";
                            ...
                            $masonry_layout_data["masonry_layout_thumbnail_description_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $masonry_layout_data_serialize);
                            ...
                            $slideshow_layout_data["slideshow_layout_gallery_title_font_family"] = "Lato:700";
                            ...
                            $slideshow_layout_data["slideshow_layout_gallery_description_font_family"] = "Lato:300";
                            ...
                            $slideshow_layout_data["slideshow_layout_thumbnail_title_font_family"] = "Lato:700";
                            ...
                            $slideshow_layout_data["slideshow_layout_thumbnail_description_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $slideshow_layout_data_serialize);

                            $image_browser_layout_data = array();
                            $image_browser_layout_data["image_browser_layout_container_width"] = "100";
                            $image_browser_layout_data["image_browser_layout_background_color"] = "#ebe8eb";
                            ...
                            $image_browser_layout_data["image_browser_layout_general_buttons_font_family"] = "Lato:700";
                            ...
                            $image_browser_layout_data["image_browser_layout_gallery_title_font_family"] = "Lato:700";
                            ...
                            $image_browser_layout_data["image_browser_layout_gallery_description_font_family"] = "Lato:300";
                            ...
                            $image_browser_layout_data["image_browser_layout_thumbnail_title_font_family"] = "Lato:700";
                            ...
                            $image_browser_layout_data["image_browser_layout_thumbnail_description_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $image_browser_layout_data_serialize);
                            ...
                            $justified_grid_layout_data["justified_grid_layout_gallery_title_font_family"] = "Lato:700";
                            ...
                            $justified_grid_layout_data["justified_grid_layout_gallery_description_font_family"] = "Lato:300";
                            ...
                            $justified_grid_layout_data["justified_grid_layout_thumbnail_title_font_family"] = "Lato:700";
                            ...
                            $justified_grid_layout_data["justified_grid_layout_thumbnail_description_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $justified_grid_layout_data_serialize);
                            ...
                            $blog_style_layout_data["blog_style_layout_gallery_title_font_family"] = "Lato:700";
                            ...
                            $blog_style_layout_data["blog_style_layout_gallery_description_font_family"] = "Lato:300";
                            ...
                            $blog_style_layout_data["blog_style_layout_thumbnail_title_font_family"] = "Lato:700";
                            ...
                            $blog_style_layout_data["blog_style_layout_thumbnail_description_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $blog_style_layout_data_serialize);
                            ...
                            $compact_album_layout_data["compact_album_layout_title_font_family"] = "Lato:700";
                            ...
                            $compact_album_layout_data["compact_album_layout_description_font_family"] = "Lato:300";
                            ...
                            $compact_album_layout_data["compact_album_layout_gallery_title_font_family"] = "Lato:700";
                            ...
                            $compact_album_layout_data["compact_album_layout_gallery_description_font_family"] = "Lato:300";
                            ...
                            $compact_album_layout_data["compact_album_layout_button_text_font_family"] = "Lato:700";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $compact_album_data_serialize);
                            ...
                            $extended_album_layout_data["extended_album_layout_title_font_family"] = "Lato:700";
                            ...
                            $extended_album_layout_data["extended_album_layout_description_font_family"] = "Lato:300";
                            ...
                            $extended_album_layout_data["extended_album_layout_gallery_title_font_family"] = "Lato:700";
                            ...
                            $extended_album_layout_data["extended_album_layout_gallery_description_font_family"] = "Lato:300";
                            ...
                            $extended_album_layout_data["extended_album_layout_button_text_font_family"] = "Lato:700";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $extended_album_data_serialize);
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $custom_css_data_serialize);
                            break;
                        ...
                        case "lightboxes_settings":
                            ...
                            $fancy_box_setting["fancy_box_title_line_height"] = "1.7em";
                            $fancy_box_setting["fancy_box_title_font_family"] = "Lato:700";
                            $fancy_box_setting["fancy_box_description"] = "true";
                            $fancy_box_setting["fancy_box_description_line_height"] = "1.7em";
                            $fancy_box_setting["fancy_box_description_font_style"] = "12,#000000";
                            $fancy_box_setting["fancy_box_description_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $fancy_box_data_serialize);
                            ...
                            $color_box_settings["lightbox_color_box_title_line_height"] = "1.7em";
                            $color_box_settings["lightbox_color_box_title_font_family"] = "Lato:700";
                            ...
                            $color_box_settings["lightbox_color_box_description_line_height"] = "1.7em";
                            $color_box_settings["lightbox_color_box_description_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $color_box_setting_serialize);
                            ...
                            $foo_box_settings["foo_box_title_font_family"] = "Lato:700";
                            ...
                            $foo_box_settings["foo_box_description_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $foo_box_settings_serialize);
                            ...
                            $nivo_lightbox_settings["lightbox_nivo_title_line_height"] = "1.7em";
                            $nivo_lightbox_settings["lightbox_nivo_title_font_family"] = "Lato:700";
                            ...
                            $nivo_lightbox_settings["lightbox_nivo_description_line_height"] = "1.7em";
                            $nivo_lightbox_settings["lightbox_nivo_description_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $nivo_lightbox_serialize);
                            ...
                            $lightcase_settings["lightcase_counter_font_family"] = "Lato:700";
                            ...
                            $lightcase_settings["lightcase_image_title_line_height"] = "1.7em";
                            $lightcase_settings["lightcase_image_title_font_family"] = "Lato:700";
                            ...
                            $lightcase_settings["lightcase_image_description_line_height"] = "1.7em";
                            $lightcase_settings["lightcase_image_description_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $lightcase_settings_serialize);
                            break;
                        ...
                        case "general_settings":
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $global_options_serialize);
                            ...
                            $lazyload_settings["loader_font_family"] = "Lato:700";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $lazyload_settings_serialize);

                            $searchbox_settings = array();
                            $searchbox_settings["search_box_font_style"] = "14,#000000";
                            $searchbox_settings["search_box_font_family"] = "Lato:700";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $searchbox_settings_serialize);

                            $orderby_settings = array();
                            $orderby_settings["order_by_font_style"] = "14,#000000";
                            $orderby_settings["order_by_font_family"] = "Lato:700";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $orderby_settings_serialize);

                            $filter_settings = array();
                            $filter_settings["filters_font_style"] = "14,#000000";
                            $filter_settings["filters_font_family"] = "Lato:700";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $filter_settings_serialize);
                            ...
                            $page_navigation["page_navigation_font_family"] = "Lato:700";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $page_navigation_serialize);
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $watermark_settings_serialize);
                            ...
                            $advertisement["advertisement_font_family"] = "Lato:300";
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $advertisement_serialize);
                            break;
                        ...
                        case "roles_and_capabilities_settings":
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $roles_data_serialize);
                            break;
                        ...
                        case "other_settings":
                            ...
                            $obj_dbHelper_gallery_master_meta_table->insertCommand(gallery_master_meta(), $other_settings_serialize);
                            break;
                    }
                }
            }
        ...
        if (!function_exists("get_parent_id_gallery_master")) {
            ...
            function get_parent_id_gallery_master($type) {
                ...
                $parent_id = $wpdb->get_var
                        ...
                        $wpdb->prepare
                                (
                                "SELECT id FROM " . gallery_master_parent() . " WHERE " . gallery_master_parent() . ". type = %s", $type
                        )
                );
                return $parent_id;
            }
        ...
        if (!function_exists("get_thumbnail_dimension_gallery_master")) {
                ...
                $thumbnail_data = $wpdb->get_var
                        ...
                        $wpdb->prepare
                                ...
                                "SELECT meta_value FROM " . gallery_master_meta() . "
                                                   WHERE " . gallery_master_meta() . ".meta_key = %s", "global_options_settings"
                        )
                );
        ...
        $obj_dbHelper_gallery_master = new dbHelper_install_script_gallery_master();
        switch ($gallery_master_version_number) {
            case "":
                ...
                $obj_dbHelper_gallery_master->insertCommand(gallery_master_parent(), $insert_parent_table_data);

                $count_gallery = $wpdb->get_var
                        (
                        $wpdb->prepare
                                (
                                "SELECT count(id) FROM " . gallery_master_parent() . " WHERE " . gallery_master_parent() . ". type = %s", "gallery"
                        )
                );
                if ($count_gallery == 0) {
                    ...
                    $gallery_id = $obj_dbHelper_gallery_master->insertCommand(gallery_master_parent(), $insert_gallery);
                    ...
                    $obj_dbHelper_gallery_master->insertCommand(gallery_master_meta(), $insert_gallery_data);
                    ...
                    for ($flag = 0; $flag < count($images); $flag++) {
                        ...
                        $fileName = wp_unique_filename(GALLERY_MASTER_ORIGINAL_DIR, $image_name);

                        $src_file = GALLERY_MASTER_PLUGIN_DIR_URL . "/assets/admin/images/" . $image_name;
                        copy($src_file, GALLERY_MASTER_ORIGINAL_DIR . $fileName);
                        copy($src_file, GALLERY_MASTER_UPLOAD_DIR . $fileName);

                        $thumbnail_image_name = $obj_dbHelper_gallery_master->createThumbs_gallery_master($image_name, $image_data);
                        $image_exif_detail = $obj_dbHelper_gallery_master->file_exif_information_gallery_master(GALLERY_MASTER_UPLOAD_DIR . $image_name, "FILE");
                        ...
                        $image_id = $obj_dbHelper_gallery_master->insertCommand(gallery_master_meta(), $image_meta_data_insert);
                    }
                }
                break;
            default:
                ...
                $parent_table_data = $wpdb->get_var
                        ...
                        $wpdb->prepare
                                (
                                "SELECT count(type) FROM " . gallery_master_parent() . " WHERE type=%s", "serialized_data"
                        )
                );
                if ($parent_table_data == 0) {
                    // get gallery data from parent table
                    $manage_gallery = $wpdb->get_results
                            (
                            "SELECT * FROM " . gallery_master_parent()
                    );
                    // get data from meta table
                    $manage_gallery_pic_data = $wpdb->get_results
                            (
                            "SELECT * FROM " . gallery_master_meta()
                    );
                    $wpdb->query("DROP TABLE IF EXISTS " . gallery_master_parent());
                    $wpdb->query("DROP TABLE IF EXISTS " . gallery_master_meta());
                    $wpdb->query("DROP TABLE IF EXISTS " . $wpdb->prefix . "gallery_master_settings");

                    if (count($wpdb->get_var("SHOW TABLES LIKE '" . gallery_master_parent() . "'")) == 0) {
                        table_gallery_master();
                    }
                    if (count($wpdb->get_var("SHOW TABLES LIKE '" . gallery_master_meta() . "'")) == 0) {
                        table_gallery_master_meta();
                    }
                    ...
                    $parent_id = $wpdb->get_var
                            ...
                            $wpdb->prepare
                                    (
                                    "SELECT id FROM " . gallery_master_parent() . "
                                WHERE " . gallery_master_parent() . ". type = %s", "galleries"
                            )
                    );
                    ...
                    foreach ($gallery_data_unserialized_data as $key) {
                        ...
                        foreach ($manage_gallery as $pic_key => $val) {
                            if ($val->type == "pic" && $val->parent_id == $key->gallery_id) {
                        ...
                        foreach ($pic_parent_unserialized_data as $data) {
                            ...
                            $image_meta_data["gallery_cover_image"] = $count == 0 ? 1 : "";
                            $image_meta_data["width"] = intval($image_exif_detail["width"]);
                            $image_meta_data["height"] = intval($image_exif_detail["height"]);
                            $image_meta_data["mime_type"] = esc_attr($image_exif_detail["mime_type"]);
                            $image_meta_data["aperture"] = esc_attr($image_exif_detail["exif_information"]["aperture"]);
                            ...
                            $image_meta_data_insert["meta_key"] = "image_data";
                            $image_meta_data_insert["meta_value"] = serialize($image_meta_data);
                            $obj_dbHelper_gallery_master->insertCommand(gallery_master_meta(), $image_meta_data_insert);
                            $count++;
                        }
        ...
        update_option("gallery-master-key", "2.0");
    }
}